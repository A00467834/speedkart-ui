                ...
                <form ref={c => (this.form = c)} onSubmit={this.handleSubmit}>
                    <div className="form-group">
                        <input
                            type="tel"
                            name="number"
                            className={this.state.isCardNumberValid !== false? "form-control":"form-control invalid"}
                        ...
                        />
                        {
                            this.state.isCardNumberValid=== false && <small>
                                {this.getCardErrorText()}
                            </small>
                        }
                    ...
                    <div className="form-group">
                        <input
                            type="text"
                            name="name"
                            className={this.state.isNameOnCardValid !== false? "form-control":"form-control invalid"}
                            placeholder="Name"
                            required
                            onChange={this.handleInputChange}
                            onFocus={this.handleInputFocus}
                            ...
                            />
                        {
                            this.state.isNameOnCardValid === false && <small>
                                {this.getNameErrorText()}
                            </small>
                        }
                    </div>
                    <div className="row">
                        <div className="col-6">
                            <input
                                type="tel"
                                name="expiry"
                                className={this.state.isExpiryValid !== false? "form-control":"form-control invalid"}
                            ...
                            />
                            {
                                this.state.isExpiryValid === false && <small>
                                    {this.getExpiryErrorText()}
                                </small>
                            }
                        </div>
                        <div className="col-6">
                            <input
                                type="tel"
                                name="cvc"
                                className={this.state.isCVCValid !== false? "form-control":"form-control invalid"}
                                placeholder="CVC"
                                pattern="\d{3}"
                                required
                                maxLength={3}
